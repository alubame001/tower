...
export default class CharacterSelectBoard extends PIXI.Container {
  ...
  constructor () {
    ...
    this.background =  new PIXI.Sprite(app.loader.resources.board.texture)//new PIXI.Sprite.fromImage('images/board.png')
